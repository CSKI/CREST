...
class DocumentNoAddExtractor:
    ...
    def _build_prompt(self, paper_text: str, schema, exp_table: Optional[str]=None) -> str:
        return f"""Extract experimental records from the chemistry paper. Only include fields defined in the schema. Omit any extra data. Output as JSON array of objects. Minimize whitespace.
Paper: {paper_text}
Schema: {schema}
Output format:
```json
